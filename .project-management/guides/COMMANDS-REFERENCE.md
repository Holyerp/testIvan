...
- **Quick guide:** [project-status.md](../../.claude/commands/how-to-use/project-status.md)
...
- **Check status:** [../.claude/commands/how-to-use/project-status.md](../../.claude/commands/how-to-use/project-status.md)
